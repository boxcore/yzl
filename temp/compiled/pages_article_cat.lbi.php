...
<div class="page_up"><span>共<?php echo $this->_var['pager']['record_count']; ?>条记录，分<?php echo $this->_var['cat_page_info']['tot_page']; ?>页显示，每页<?php echo $this->_var['cat_page_info']['size']; ?>条</span>[
...
?>
        ...
        <a href="<?php echo $this->_var['item']; ?>" class="red"><?php echo $this->_var['key']; ?></a>
        <?php else: ?>
    ...
    <?php endif; ?>
    <?php if ($this->_var['pager']['page_count'] == 1): ?>
    <a href="<?php echo $this->_var['item']; ?>" class="red">1</a>
    <?php endif; ?>
