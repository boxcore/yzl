...
?>
                <dl<?php if ($this->_var['article']['article_type'] == 1): ?> class="red"<?php endif; ?>><dt><a href="<?php echo $this->_var['article']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['article']['title']); ?>">[<?php echo $this->_var['article']['add_time']; ?>]<?php echo $this->_var['article']['short_title']; ?></a></dt><dd>重庆</dd></dl>
