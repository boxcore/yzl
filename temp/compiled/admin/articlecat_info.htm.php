...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td>
      <select name="catType" onchange="catChanged()" <?php if ($this->_var['disabled']): ?>disabled="disabled"<?php endif; ?> >
        <option <?php if ($this->_var['catType'] == 1): ?>selected<?php endif; ?> value="1">普通</option>
        <option <?php if ($this->_var['catType'] == 5): ?>selected<?php endif; ?> value="5">帮助</option>
        <option <?php if ($this->_var['catType'] == 6): ?>selected<?php endif; ?> value="6">下载</option>
        <option <?php if ($this->_var['catType'] == 7): ?>selected<?php endif; ?> value="7">图片下载</option>
        <option <?php if ($this->_var['catType'] == 8): ?>selected<?php endif; ?> value="8">视频下载</option>
        <option <?php if ($this->_var['catType'] == 9): ?>selected<?php endif; ?> value="9">招聘</option>
         <option <?php if ($this->_var['catType'] == 10): ?>selected<?php endif; ?> value="10">新闻</option>
      </select>
    </td>
  </tr>
  ...
  <tr>
   ...
   <!--代码增加 start By thunje#URLdf-->
		  <tr>
            <td class="label"><font color=#ff3300>自定义URL：</font></td>
            <td>
			<input type="text" name="define_url" value="<?php echo $this->_var['cat']['define_url']; ?>" size="30"  /><br><span class="notice-span" >只能输入数字、字母以及 _ ,除此之外不能输入其他字符
			</span>
			<input type="hidden" name="old_define_url" value="<?php echo $this->_var['cat']['define_url']; ?>" />
			</td>
          </tr>
	<!--代码增加 end By thunje#URLdf-->
  ...
  <tr>
    <td class="label">分类内容</td>
    <style>
      #FCKeditor1___Frame {width: 300px; height: 50px; border: 1px solid #ccc;}
    </style>
