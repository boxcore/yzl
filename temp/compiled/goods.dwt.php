  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="clearfix">
      ...
      <a href="<?php echo $this->_var['prev_good']['url']; ?>"><img alt="prev" src="themes/yzl_v1/images/up.gif" /></a>
      <?php endif; ?>
      <?php if ($this->_var['next_good']): ?>
      <a href="<?php echo $this->_var['next_good']['url']; ?>"><img alt="next" src="themes/yzl_v1/images/down.gif" /></a>
      <?php endif; ?>
      </p>
      </div>
      <ul>
...
?>
      ...
      <img src="themes/yzl_v1/images/stars<?php echo $this->_var['goods']['comment_rank']; ?>.gif" alt="comment rank <?php echo $this->_var['goods']['comment_rank']; ?>" />
       </dd>
      </li>
...
?>
      ...
      <li class="padd">
      <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/yzl_v1/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/yzl_v1/images/bnt_colles.gif" /></a>
      <?php if ($this->_var['affiliate']['on']): ?>
      <a href="user.php?act=affiliate&goodsid=<?php echo $this->_var['goods']['goods_id']; ?>"><img src='themes/yzl_v1/images/bnt_recommend.gif'></a>
      <?php endif; ?>
      </li>
      </ul>
      </form>
...
?>
          ...
          <td bgcolor="#FFFFFF">
          <a href="javascript:addPackageToCart(<?php echo $this->_var['package_goods']['act_id']; ?>)" style="background:transparent"><img src="themes/yzl_v1/images/bnt_buy_1.gif" alt="<?php echo $this->_var['lang']['add_to_cart']; ?>" /></a>
          </td>
        </tr>
       </table>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
