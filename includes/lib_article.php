...
function get_cat_articles($cat_id, $page = 1, $size = 20 ,$requirement='')
{
    ...
    if ($requirement != '')
    {
        $sql = 'SELECT article_id, title, content, author, add_time, file_url, open_type, article_type, article_img, original_img, article_icon_1, article_icon_2' .
    ...
    if ($res)
    {
        while ($row = $GLOBALS['db']->fetchRow($res))
        {
            ...
            $arr[$article_id]['content']       = get_brief($row['content'],50);
            ...
            $arr[$article_id]['original_img']    = $row['original_img'];
            $arr[$article_id]['article_icon_1']    = $row['article_icon_1'];
            $arr[$article_id]['article_icon_2']    = $row['article_icon_2'];
