...
function get_profile($user_id)
{
    ...
    $info  = array();
    $infos = array();
    $sql  = "SELECT user_name,real_name, birthday, sex, question, answer, rank_points, pay_points,user_money, user_rank,".
    ...
    $info['real_name']   = isset($infos['real_name']) ? $infos['real_name'] : $_SESSION['real_name'];
