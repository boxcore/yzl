	...
	try {
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			TB_WIDTH = (params['width']*1); //defaults to 630 if no paramaters were added to URL
			TB_HEIGHT = (params['height']*1); //defaults to 440 if no paramaters were added to URL
